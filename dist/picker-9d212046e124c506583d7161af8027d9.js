			...
			f = Backbone.View.extend({
				...
				initAMap: function() {
					...
					var c, e = this,
						...
						h = g.zoom ? parseInt(g.zoom) : 15;
					if(c = new AMap.Map("map-view", {
							level: h,
							resizeEnable: !0
						}), d = c, c.plugin(["AMap.Scale"], function() {
							c.addControl(new AMap.Scale)
						}), g.center) {
						var i = g.center.split(",");
						e.drawMarker(i, "index"), a = i, f.set("pickCenter", i)
				...
				searchBack: function() {
					this.model.set("search_tips", ""), $(".search_page").remove(), $(".picker-index").removeClass("active")
				},
				customBack: function() {
